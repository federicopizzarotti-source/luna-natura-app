    ...
    public static void applicaStilePillola(TextView tv, ConsiglioData.Valutazione v, float density,
        ...
        switch (v) {
            case OTTIMO: case FAVOREVOLE:
                sfondo = R.color.val_ottimo_sfondo; bordo = R.color.val_ottimo_bordo; testo = R.color.val_ottimo_testo; break;
            case BUONO:
                sfondo = R.color.val_buono_sfondo; bordo = R.color.val_buono_bordo; testo = R.color.val_buono_testo; break;
            case NEUTRO:
                sfondo = R.color.val_neutro_sfondo; bordo = R.color.val_neutro_bordo; testo = R.color.val_neutro_testo; break;
            case SCONSIGLIATO:
                sfondo = R.color.val_warn_sfondo; bordo = R.color.val_warn_bordo; testo = R.color.val_warn_testo; break;
            default:
                sfondo = R.color.val_evita_sfondo; bordo = R.color.val_evita_bordo; testo = R.color.val_evita_testo; break;
        }
